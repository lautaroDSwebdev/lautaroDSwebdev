...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,tailwind,typescript,springboot,react,astro,next,figma,vite,npm,yarn,notion,powershell,bash,scss,vscode,git,netlify,linkedin,firebase,discord,codepen)](https://skillicons.dev)
